...
export default defineComponent({
    ...
    methods: {
        Calcmacro() {
            this.calcFlg = true
            this.$store.state.totalkcal = Math.round((10 * this.$store.state.weightinfo + 6.25 * this.$store.state.heightinfo - 5 * this.$store.state.ageinfo - 161) * this.$store.state.picked)
